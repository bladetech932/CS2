...
public class WebBrowserModel 
{
    ...
    {
        //String trimmedUrl = url.substring(7, url.length());
        String trimmedUrl = getHostFromURL();
        try
        {
            //System.out.println("TrimmedUrl: " + trimmedUrl);
            Socket s = new Socket(trimmedUrl, 2000);
     System.out.println("Socket opened on port 2000 in method getSocketFromUrl");
            return s;
        }
        catch (UnknownHostException e)
        {
